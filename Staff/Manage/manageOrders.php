...
table{width:100%;border-collapse:collapse}th,td{padding:10px 12px;border-bottom:1px solid #e0e0e0;text-align:left}th{font-weight:500;color:#5f6368;font-size:13px}
...
<div class="tbl-wrap"><table><thead><tr><th>ID</th><th>Customer</th><th>Furniture</th><th>Qty</th><th>Total</th><th>Delivery</th><th>Status</th><th>Change Status</th><th>Change Qty</th></tr></thead><tbody>
