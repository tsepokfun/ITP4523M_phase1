...
$r=mysqli_query($conn,"SELECT * FROM Staff ORDER BY staff_id");
...
<div class="tbl-wrap"><table><thead><tr><th>ID</th><th>Name</th><th>Password</th><th>Edit</th><th>Delete</th></tr></thead><tbody>
