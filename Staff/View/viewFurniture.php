...
<style>.main-content{padding:24px 32px}.tbl-wrap{background:#fff;border-radius:20px;padding:20px;overflow-x:auto;box-shadow:0 1px 3px rgba(0,0,0,.06)}table{width:100%;border-collapse:collapse}th,td{padding:12px 14px;border-bottom:1px solid #e0e0e0;text-align:left}th{font-weight:500;color:#5f6368;font-size:13px}.low{color:#d93025;font-weight:500}.thumb{width:120px;height:68px;object-fit:contain;border-radius:8px;border:1px solid #e0e0e0;background:#fafafa}</style></head>
