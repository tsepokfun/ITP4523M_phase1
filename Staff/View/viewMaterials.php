...
$r=mysqli_query($conn,"SELECT * FROM Material ORDER BY material_id");
...
<div class="content-container"><div class="tbl-wrap"><table><thead><tr><th>ID</th><th>Name</th><th>Quantity</th><th>Unit</th></tr></thead><tbody>
